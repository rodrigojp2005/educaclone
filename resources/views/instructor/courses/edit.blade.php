...
@section('instructor-page-title','Editar Curso')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <a href="{{ route('instructor.courses.index') }}" class="btn btn-link">« Voltar</a>
    <a href="{{ route('instructor.courses.lessons.index', $course) }}" class="btn btn-outline-secondary">Gerenciar Aulas</a>
 </div>

<div class="card shadow">
    <div class="card-body">
        <form method="POST" action="{{ route('instructor.courses.update', $course) }}" class="row g-3">
            @csrf
            @method('PUT')
            <div class="col-md-8">
            ...
            <div class="col-12">
                ...
                <a href="{{ route('instructor.courses.index') }}" class="btn btn-secondary">Voltar</a>
            </div>
        </form>
    </div>
</div>
